...
export function Footer() {
  ...
  return (
    <footer className="bg-slate-900 text-slate-300 scroll-mt-24">
      {/* Main footer */}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">
                  2 Market Street, West Chester, PA 19380
                </span>
              </li>

              <li>
                <a
                  href="tel:+16102231946"
              ...
              <li>
                <a
                  href="mailto:dmitchell@corrsafety.com"
                  className="flex items-center gap-3 hover:text-emerald-400 transition-colors"
                >
                  <Mail className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                  <span className="text-sm break-all sm:break-normal">
                    dmitchell@corrsafety.com
                  </span>
                </a>
              </li>
            </ul>
            ...
            <div className="mt-4 pt-3 border-t border-slate-700/60">
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                CAGE Code: 8LX95 | UEI: ZS6CGJFSHLA8
              </p>
            </div>
          </div>
        </div>

...
export function Team() {
  ...
  const teamMembers = [
    { name: 'John Correale, CSP', role: 'CEO', image: teamPlaceholder },
    { name: 'Joe Whalen, CSP', role: 'VP of Operations', image: teamPlaceholder },
    { name: 'Mike Shanline, SMS', role: 'VP of Business Development', image: teamPlaceholder },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">
            Leadership <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-green-600">Team</span>
          </h2>
